;(function () {
  ...
  appendScript(prefix + 'hero-shader-background.js')
  appendScript(prefix + 'pricing-reference.js')
  appendScript(prefix + 'hero-front-facing.js')
  appendScript(prefix + 'case-name-margo.js')

  function loadLegacyParticles() {
    const legacyParticles = appendScript('https://raw.githack.com/Kossbarss/-/4dae747eee4f0c35bd612daa5779babcc4d13777/particles.js')
    legacyParticles.dataset.feature = 'legacy-footer-particles-and-gallery-border'
  }
